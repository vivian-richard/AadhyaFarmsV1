...
const MobileSubscriptions = () => {
  ...
  const handleSubscribe = (plan: any) => {
    // Create default delivery schedule based on frequency
    const defaultSchedule = {
      monday: selectedFrequency === 'daily',
      tuesday: selectedFrequency === 'daily',
      wednesday: selectedFrequency === 'daily',
      thursday: selectedFrequency === 'daily',
      friday: selectedFrequency === 'daily',
      saturday: selectedFrequency === 'daily',
      sunday: selectedFrequency === 'daily'
    };

    // For weekly, alternate, enable alternate days
    if (selectedFrequency === 'weekly') {
      defaultSchedule.sunday = true;
      defaultSchedule.monday = false;
      defaultSchedule.tuesday = false;
      defaultSchedule.wednesday = false;
      defaultSchedule.thursday = false;
      defaultSchedule.friday = false;
      defaultSchedule.saturday = false;
    } else if (selectedFrequency === 'alternate') {
      defaultSchedule.monday = true;
      defaultSchedule.tuesday = false;
      defaultSchedule.wednesday = true;
      defaultSchedule.thursday = false;
      defaultSchedule.friday = true;
      defaultSchedule.saturday = false;
      defaultSchedule.sunday = false;
    }
